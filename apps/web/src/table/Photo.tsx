...
const styles: Record<string, React.CSSProperties> = {
  ...
  wrap: {
    ...
    transition:
      "left 600ms cubic-bezier(0.455,0.03,0.515,0.955), top 600ms cubic-bezier(0.455,0.03,0.515,0.955)",
  },
  photo: {
    position: "absolute",
    inset: 0,
  ...
  limitSkillName: {
    ...
    fontSize: 11,
    fontWeight: 700,
    textShadow: "0 0 2px #3D2D1C, 0 1px 1px #3D2D1C",
    whiteSpace: "nowrap",
    maxWidth: 39,
    overflow: "hidden",
  },
