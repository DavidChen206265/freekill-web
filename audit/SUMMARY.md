...
- **P 协议上报剩余 3 项**：prelight 预亮（F7）、changeskin 换肤、ChangeRoom 改房——asio 支持但 web 前端无入口；投降/托管/房主踢人已于 2026-06-13 补齐并验证，托管补强为点击后立即本地清理当前询问 UI、显示「退出托管」并阻断其它交互。
