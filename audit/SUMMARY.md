...
> 修复进度：10 条中 **M3、N2、H6、E9、B40、B41、D11、I8 已处理**（2026-06-12；E9 为误判；I8 核心 bug 修复后降为简化还原，弹幕分流待 I9）；剩 1 条（C29，依赖未还原的 C3 战绩面板，属信息完整度批次）。N20 与 H20–H24 一致改判简化还原（emoji 飞行为 IG-5b 有意简化）。
