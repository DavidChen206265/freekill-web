...
| **合计** | | **160** | **124** | **3** | **172** | **459** |

> 上表为修复后的当前值。初始审计合计错误 10/完全 165。已处理:M3(M)、N2(N)、H6(H)、E9(E)、B40/B41(B)、D11(D) → 错误降至 3、完全升至 172。
...
> 修复进度：10 条中 **M3、N2、H6、E9、B40、B41、D11 已处理**（2026-06-12；E9 经源码复核为误判）；剩 3 条待修复（C29、I8、N20）。
