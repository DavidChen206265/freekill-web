...
> 初始审计(2026-06-12)为 未还原 160 / 简化 124 / 还原错误 10 / 完全 165。**修复进度**:M3、N2 已修复并验证(还原错误→完全还原),故错误 10→8、完全 165→167。完全还原率 167/459 ≈ 36%。以各 Phase 报告的 `修复:` 标注为准。
...
> 修复进度：10 条中 **M3、N2 已修复并验证**（2026-06-12）；剩 8 条待修复。
