...
| **合计** | | **160** | **124** | **6** | **169** | **459** |

> 上表为修复后的当前值。初始审计合计错误 10/完全 165。已处理:M3(M)、N2(N)、H6(H)、E9(E) → 错误降至 6、完全升至 169。
...
> 修复进度：10 条中 **M3、N2、H6、E9 已处理**（2026-06-12；E9 经源码复核为误判，等价于原版）；剩 6 条待修复。
