...
- web : 无（仅建房开关 enableFreeAssign）
- 原版行为: 自由选将 Cheat：按武将包列表 → 选包看该包武将网格，或搜索框 searchAllGenerals 全局搜，点击武将把其赋给目标卡（自由指定武将）
- web 行为: CreateRoomDialog.tsx:27,73 只有"自由选将"建房开关（enableFreeAssign 传给服务器 _game），**没有**游戏内自由选将的包/搜索/选将赋予面板；grep searchAllGenerals|getAllGeneralPack|getGenerals 零命中
...
| 简化还原 | 3 | L1, L2, L11 |
| 还原错误 | 0 | — |
| 未还原 | 13 | L3, L6, L8, L9, L10, L12, L13, L14, L15, L16, L17, L18, L19 |
| 合计 | 19 | |

未还原索引: L3 战绩统计 / L6 记牌器 / L8 屏蔽发言 / L9 踢人(原版亦注释) / L10 换肤入口(原版亦注释) / L12 武将体力显示 / L13 卡牌详情 / L14 手牌选择器 / L15 查看牌堆 / L16 查看将堆 / L17 同名替换 / L18 自由选将面板 / L19 皮肤选择
还原错误索引: 无
