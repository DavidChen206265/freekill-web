...
- 差异: 视觉用 emoji 替代原版精灵帧，非像素级还原。
- 修复: 分类订正 (与其 5 个同源条目 H20–H24 一致改判为**简化还原**——同一 IG-5b 设计决策的两个 Phase 视角:有意用 emoji 飞行替代精灵帧,功能完整[送花/砸蛋飞向目标],非 bug。真正升级到精灵帧属 N5 观感批次,与 H20–H24 一并做。2026-06-12)
...
| 简化还原 | 12 | N1, N5, N7, N10, N11, N12, N15, N16, N17, N20, N31, N32 |
| 还原错误 | 0 | （N20 分类订正为简化还原 2026-06-12，与 H20–H24 一致） |
| 未还原 | 4 | N3, N23, N28, N29 |

（完全还原实计 18：N2/N4/N6/N8/N9/N13/N14/N18/N19/N21/N22/N24/N25/N26/N27/N30/N33/N34；简化 12；错误 0；未还原 4。总 34 项。N2 已修复并验证升级为完全还原；N20 与同源 H20–H24 一致改判简化还原。2026-06-12）
...
- ~~**N20** 聊天投掷动画~~ → 分类订正为简化还原（2026-06-12，与同源 H20–H24 一致；emoji 飞行是 IG-5b 有意简化，非 bug）
- （本 Phase 还原错误清零）
...
3. **武将头像 avatar/ 小图未还原（N3）** —— generalAvatar 函数存在但无调用，全用文字占位。
